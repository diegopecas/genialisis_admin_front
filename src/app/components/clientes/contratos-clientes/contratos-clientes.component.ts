...
export class ContratosClientesComponent {
  ...
  public acciones = [
    { id: 'descargar_pdf', label: 'Descargar PDF', icono: 'mdi mdi-file-pdf-box', condicion: 'mostrar_descargar', valor: true },
    { id: 'desmarcar_firmado', label: 'Desmarcar Firmado', icono: 'mdi mdi-signature-freehand', condicion: 'mostrar_desmarcar_firmado', valor: true },
  ] as any[];
