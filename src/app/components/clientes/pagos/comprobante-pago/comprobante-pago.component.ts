...
export class ComprobantePagoComponent implements OnInit {
  ...
  @Input() representante!: RepresentanteModel;
  @Input() tipoPago: any = {};
  @Input() origenNavegacion: string = 'cliente'; // Nuevo Input
  ...
  ngOnInit(): void {
    ...
    console.log("ComprobantePagoComponent", this.pago, this.cliente, this.representante);
    
    if (!this.pago || !this.cliente || !this.representante) {
