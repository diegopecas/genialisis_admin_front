...
export class ComprobantePagoComponent implements OnInit {
  ...
  @Input() estudiante!: EstudianteModel;
  @Input() acudiente!: AcudienteModel;
  @Input() tipoPago: any = {};
  @Input() origenNavegacion: string = 'estudiante'; // Nuevo Input
  ...
  ngOnInit(): void {
    ...
    console.log("ComprobantePagoComponent", this.pago, this.estudiante, this.acudiente);
    
    if (!this.pago || !this.estudiante || !this.acudiente) {
