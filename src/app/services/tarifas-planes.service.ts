...
export class TarifasPlanesService {

  private servicio = environment.api + 'tarifas-planes';
  ...
  obtenerByPlan(idPlan: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + `/plan/${idPlan}`, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
  ...
  obtenerByPlanAnio(idPlan: any, anio: any) {
    return this.http
      .get<HttpResponse<Object>>(this.servicio + `/plan/${idPlan}/anio/${anio}`, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
