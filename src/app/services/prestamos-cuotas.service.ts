...
export class PrestamosCuotasService {
  private servicio = environment.api + 'prestamos-cuotas';
  ...
  obtenerPorPrestamo(idPrestamo: any) {
    return this.http
  ...
  crearBatch(body: any) {
    return this.http
      .post<HttpResponse<Object>>(this.servicio + '-batch', body, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
