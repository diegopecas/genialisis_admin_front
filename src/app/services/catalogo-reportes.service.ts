...
export class CatalogoReportesService {
  private servicio = environment.api + 'catalogo-reportes';
  ...
  obtenerParaEntesControl() {
    return this.http
      .get<HttpResponse<Object>>(`${this.servicio}/entes-control`, {
        observe: 'response',
      })
      .pipe(
        tap((response: HttpResponse<Object>) => {
