...
export class MigracionCatalogoBloquesService {

  private servicio = environment.api + 'migracion-catalogo-bloques';
  ...
  private handleError(error: HttpErrorResponse): Observable<never> {
    console.error('Error en MigracionCatalogoBloquesService:', error);
